...
#ifdef _WIN32
#include <Windows.h>
#define вперёд_славяне setlocale(LC_ALL, ".utf8")
#else
#include <unistd.h>
...
#define умножать pow
#define ХОЗЯЙСТВО_ЦАРЯ (__builtin_inff())
...
хутор Сибирь
{
	...
	свет_мой_зеркальце <скажи Тип>
	Сибирь::РавнобокоеДрево<Тип>::РавнобокоеДрево(приказ_княжий РавнобокоеДрево<Тип>& засланец)
	{
	...
	РавнобокоеДрево<Тип>& РавнобокоеДрево<Тип>::оператор = (приказ_княжий РавнобокоеДрево<Тип>&засланец)
	{
		...
		свет_мой_зеркальце <скажи Тип>
		Сибирь::РавнобокоеДрево<Тип>::РавнобокоеДрево(РавнобокоеДрево<Тип>&& засланец)
		{
